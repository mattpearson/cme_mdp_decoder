...
#ifndef _MKTDATA_MDINCREMENTALREFRESHTRADESUMMARY42_H_
#define _MKTDATA_MDINCREMENTALREFRESHTRADESUMMARY42_H_
...
public:
    ...
    MDIncrementalRefreshTradeSummary42(void) : m_buffer(nullptr), m_bufferLength(0), m_offset(0) {}

    MDIncrementalRefreshTradeSummary42(char *buffer, const std::uint64_t bufferLength)
    {
        reset(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    MDIncrementalRefreshTradeSummary42(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
    ...
    MDIncrementalRefreshTradeSummary42 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        reset(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
        return *this;
    }

    MDIncrementalRefreshTradeSummary42 &wrapForDecode(
    ...
    MDIncrementalRefreshTradeSummary42 &transactTime(const std::uint64_t value)
    {
...
public:
        ...
        {
            return AggressorSide::get((*((std::uint8_t *)(m_buffer + m_offset + 24))));
        }
        ...
        static SBE_CONSTEXPR const std::uint16_t mDTradeEntryIDId(void)
        {
            return 37711;
        }

        static SBE_CONSTEXPR const std::uint64_t mDTradeEntryIDSinceVersion(void)
        {
             return 7;
        }

        bool mDTradeEntryIDInActingVersion(void)
        {
            return m_actingVersion >= mDTradeEntryIDSinceVersion();
        }


        static const char *MDTradeEntryIDMetaAttribute(const MetaAttribute::Attribute metaAttribute)
        {
            switch (metaAttribute)
            {
                case MetaAttribute::EPOCH: return "unix";
        ...
        static SBE_CONSTEXPR const std::uint32_t mDTradeEntryIDNullValue()
        {
            return 4294967295;
        }

        static SBE_CONSTEXPR const std::uint32_t mDTradeEntryIDMinValue()
        {
            return 0;
        }

        static SBE_CONSTEXPR const std::uint32_t mDTradeEntryIDMaxValue()
        {
            return 4294967293;
        }

        std::uint32_t mDTradeEntryID(void) const
        {
            ...
            return SBE_LITTLE_ENDIAN_ENCODE_32(*((std::uint32_t *)(m_buffer + m_offset + 26)));
        }

        NoMDEntries &mDTradeEntryID(const std::uint32_t value)
        {
            *((std::uint32_t *)(m_buffer + m_offset + 26)) = SBE_LITTLE_ENDIAN_ENCODE_32(value);
            return *this;
        }
    };
...
public:
    ...
    public:
        ...
        inline void wrapForEncode(char *buffer, const std::uint8_t count, std::uint64_t *pos, const std::uint64_t actingVersion, const std::uint64_t bufferLength)
        {
            ...
            m_bufferLength = bufferLength;
            m_dimensions.wrap(m_buffer, *pos, actingVersion, bufferLength);
            m_dimensions.blockLength((std::uint16_t)16);
            m_dimensions.numInGroup((std::uint8_t)count);
            m_index = -1;
            m_count = count;
            m_blockLength = 16;
        ...
        static SBE_CONSTEXPR const std::uint16_t lastQtyId(void)
        {
            return 32;
        }

        static SBE_CONSTEXPR const std::uint64_t lastQtySinceVersion(void)
        {
             return 0;
        }
        ...
        static SBE_CONSTEXPR const std::int32_t lastQtyNullValue()
        {
            return SBE_NULLVALUE_INT32;
        }

        static SBE_CONSTEXPR const std::int32_t lastQtyMinValue()
        {
            return -2147483647;
        }

        static SBE_CONSTEXPR const std::int32_t lastQtyMaxValue()
        {
            return 2147483647;
        }

        std::int32_t lastQty(void) const
        {
            return SBE_LITTLE_ENDIAN_ENCODE_32(*((std::int32_t *)(m_buffer + m_offset + 8)));
        }

        NoOrderIDEntries &lastQty(const std::int32_t value)
        {
            *((std::int32_t *)(m_buffer + m_offset + 8)) = SBE_LITTLE_ENDIAN_ENCODE_32(value);
            return *this;
        }
