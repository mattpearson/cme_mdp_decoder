...
public:
    ...
    MDIncrementalRefreshVolume37(void) : m_buffer(nullptr), m_bufferLength(0), m_offset(0) {}
    ...
    MDIncrementalRefreshVolume37(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
    ...
    MDIncrementalRefreshVolume37 &transactTime(const std::uint64_t value)
    {
...
public:
    ...
    public:
        ...
        {
            return MDUpdateAction::get((*((std::uint8_t *)(m_buffer + m_offset + 12))));
        }
