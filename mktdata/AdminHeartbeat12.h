...
#ifndef _MKTDATA_ADMINHEARTBEAT12_H_
#define _MKTDATA_ADMINHEARTBEAT12_H_
...
public:
    ...
    AdminHeartbeat12(void) : m_buffer(nullptr), m_bufferLength(0), m_offset(0) {}
    ...
    AdminHeartbeat12(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
        reset(buffer, 0, bufferLength, actingBlockLength, actingVersion);
    }

    AdminHeartbeat12(const AdminHeartbeat12& codec)
    {
        reset(codec.m_buffer, codec.m_offset, codec.m_bufferLength, codec.m_actingBlockLength, codec.m_actingVersion);
    }

#if __cplusplus >= 201103L
    AdminHeartbeat12(AdminHeartbeat12&& codec)
    {
        reset(codec.m_buffer, codec.m_offset, codec.m_bufferLength, codec.m_actingBlockLength, codec.m_actingVersion);
    }

    AdminHeartbeat12& operator=(AdminHeartbeat12&& codec)
    {
        reset(codec.m_buffer, codec.m_offset, codec.m_bufferLength, codec.m_actingBlockLength, codec.m_actingVersion);
        return *this;
    }
    ...
    AdminHeartbeat12& operator=(const AdminHeartbeat12& codec)
    {
        reset(codec.m_buffer, codec.m_offset, codec.m_bufferLength, codec.m_actingBlockLength, codec.m_actingVersion);
        return *this;
    }
