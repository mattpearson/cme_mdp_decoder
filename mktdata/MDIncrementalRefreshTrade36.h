...
public:
    ...
    MDIncrementalRefreshTrade36(const MDIncrementalRefreshTrade36& codec)
    {
        reset(codec.m_buffer, codec.m_offset, codec.m_bufferLength, codec.m_actingBlockLength, codec.m_actingVersion);
    }

#if __cplusplus >= 201103L
    MDIncrementalRefreshTrade36(MDIncrementalRefreshTrade36&& codec)
    {
        reset(codec.m_buffer, codec.m_offset, codec.m_bufferLength, codec.m_actingBlockLength, codec.m_actingVersion);
    }

    MDIncrementalRefreshTrade36& operator=(MDIncrementalRefreshTrade36&& codec)
    {
        reset(codec.m_buffer, codec.m_offset, codec.m_bufferLength, codec.m_actingBlockLength, codec.m_actingVersion);
        return *this;
    }
    ...
    MDIncrementalRefreshTrade36& operator=(const MDIncrementalRefreshTrade36& codec)
    {
        reset(codec.m_buffer, codec.m_offset, codec.m_bufferLength, codec.m_actingBlockLength, codec.m_actingVersion);
        return *this;
    }
